            ...
            <form @submit.prevent="register" class="card card-form">
                ...
                <div class="form-group">
                    ...
                    <template v-if="$v.form.password.$error">
                         ...
                         <span v-if="!$v.form.password.minLength" class="form-error">The password must be 6 characters long</span>
                     </template>
                </div>
                ...
                <div class="form-group">
                    ...
                    <template v-if="$v.form.avatar.$error">
                         <span v-if="!$v.form.avatar.url" class="form-error">The URL is invalid</span>
                         <span v-else-if="!$v.form.avatar.supportedImageFile" class="form-error">The file type is not supported</span>
                         <span v-else-if="!$v.form.avatar.responseOk" class="form-error">The file cannot be found</span>
                     </template>
                </div>
